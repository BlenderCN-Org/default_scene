...
@blender_version_wrapper('<=','2.79')
def light_add(type:str='POINT', radius:float=1.0, view_align:bool=False, location:tuple=(0.0, 0.0, 0.0), rotation:tuple=(0.0, 0.0, 0.0)):
    bpy.ops.object.lamp_add(type=type, radius=radius, view_align=view_align, location=location, rotation=rotation)
@blender_version_wrapper('>=','2.80')
def light_add(type:str='POINT', radius:float=1.0, view_align:bool=False, location:tuple=(0.0, 0.0, 0.0), rotation:tuple=(0.0, 0.0, 0.0)):
    bpy.ops.object.light_add(type=type, radius=radius, view_align=view_align, location=location, rotation=rotation)
