...
class Actions:
    ...
    def update(self, context, event, timer=None, print_actions=False):
        self.just_pressed = None
        ...
        #     #print('context.space_data has no region_3d')
        #     #print(context)
        ...
        if self.timer and timer is not None:
